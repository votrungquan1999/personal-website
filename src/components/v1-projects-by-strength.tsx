  ...
  const projectsByStrength = [
    {
      ...
      projects: [
        ...
        },
        {
          ...
          challenge:
            "New warehouse staff struggled for weeks to learn the system, and experienced workers wasted hours on tedious manual data entry",
          approach:
            "Designed intuitive scanning workflows with comprehensive documentation and automated tracking",
          outcome:
            "50% reduction in training time, 70% less manual entry, 55% efficiency improvement",
    ...
    },
    {
      ...
      projects: [
        ...
        },
        {
          ...
          challenge:
            "Teams feared making changes because a single bug could break multiple unrelated features, slowing down development",
          approach:
            "Promoted and implemented event-driven architecture to decouple systems and reduce inter-service dependencies",
          outcome:
    ...
    },
    {
      ...
      projects: [
        ...
        },
        {
          ...
          approach:
            "Trained operators to use AI tools (ChatGPT, Claude) for daily tasks like documentation, data analysis, and problem-solving",
          outcome:
