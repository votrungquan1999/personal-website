  ...
  const strengthCards = [
    {
      ...
      description: "I start with understanding actual user pain points, then design intuitive solutions that eliminate unnecessary complexity. The goal is to make systems that people naturally understand and enjoy using.",
      ...
      projects: [
        {
          ...
          technologies: ["Next.js", "TypeScript", "User Research", "Workflow Design"],
        },
        {
          name: resumeData.featuredProjects[2].name, // Cross-border Tools
          company: resumeData.featuredProjects[2].company,
          challenge: "Warehouse staff needed 10 clicks per task, slowing operations and causing frequent manual entry errors",
          approach: "Designed intuitive scanning workflows with smart defaults and automated tracking",
          outcome: "80% reduction in clicks (10 → 2), 50% less training time, 70% less manual entry",
    ...
    },
    {
      ...
      description: "I build accessible, performant interfaces using modern web standards and best practices. Every user should have a smooth experience, whether they use keyboard navigation or need responsive interactions during heavy calculations.",
      // Real projects as proof
      projects: [
        {
          name: resumeData.featuredProjects[1].name, // Partners Portal
    ...
    },
    {
      ...
      description: "I optimize backend systems for both user experience and developer productivity. Through smart caching strategies and decoupled architectures, I make applications fast while keeping the codebase maintainable.",
      // Real projects as proof
      projects: [
        {
          name: resumeData.featuredProjects[1].name, // Partners Portal
        ...
        },
        {
          ...
          challenge: "Teams feared making changes because a single bug could break multiple unrelated features, slowing down development. It was also hard to change database schemas without breaking existing systems.",
          approach: "Promoted and implemented event-driven architecture with event sourcing to decouple systems and reduce inter-service dependencies",
    ...
    },
    {
      ...
      description: "I adopted GitHub Copilot in 2022 and have been leveraging AI to accelerate development ever since. Beyond personal use, I mentor teams on AI tools and train non-technical staff to automate their daily tasks.",
      // Real projects as proof
      projects: [
        {
        ...
        },
        {
          ...
          approach: "Trained operators to use AI tools (ChatGPT, agentic browser like Comet) for daily tasks like documentation, data analysis, and problem-solving",
