#!/usr/bin/env bun
/**
 * Deploy only Cloudflare DNS infrastructure
 * Usage: bun run scripts/deploy-cloudflare.ts [preview|up|destroy|refresh]
 *
...
// Set environment variables to deploy only Cloudflare
process.env.DEPLOY_VERCEL = "false";
